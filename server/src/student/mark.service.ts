...
export class MarkService {
    constructor(@InjectRepository(Mark) private readonly markRepo: Repository<Mark>) {
    ...
    async getAllBySubjectAndMonth(subject: Subject, monthOrder: number): Promise<Mark[]> {
